    ...
    def do_GET(self):
		...
		output += "</body></html>"
            ...
            if self.path.endswith("/restaurants/new"):
                ...
                output += '''<form method='POST' enctype='multipart/form-data' action='/restaurants'><h2>Enter New Name</h2><input name="newRestaurantName" type="text" ><input type="submit" value="Create"> </form>'''
                output += "</body></html>"
                self.wfile.write(output)
                return    
